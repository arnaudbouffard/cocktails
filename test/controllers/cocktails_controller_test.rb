...
class CocktailsControllerTest < ActionController::TestCase
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post :create, cocktail: { description: @cocktail.description, name: @cocktail.name, picture: @cocktail.picture }
    end
  ...
  test "should update cocktail" do
    patch :update, id: @cocktail, cocktail: { description: @cocktail.description, name: @cocktail.name, picture: @cocktail.picture }
    assert_redirected_to cocktail_path(assigns(:cocktail))
  end
